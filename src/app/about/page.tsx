    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
           ...
           <div className="relative group grayscale hover:grayscale-0 transition-smooth">
              <div className="absolute -inset-4 bg-primary/5 rounded-sm -rotate-2 group-hover:rotate-0 transition-smooth" />
              <div className="relative aspect-square rounded-sm overflow-hidden border border-border bg-white shadow-2xl">
                  <img src="https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?q=80&w=2070&auto=format&fit=crop" className="object-cover w-full h-full transition-smooth group-hover:scale-110" alt="Lab environment" />
                  ...
                  <div className="absolute bottom-10 left-10 text-white">
                     ...
                     <h3 className="text-2xl font-bold">Kanpur Center of Excellence</h3>
                  </div>
              </div>
           </div>
        </div>
      ...
      {/* Values Section with Dark Surface */}
      <section className="py-32 bg-slate-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
           <div className="text-center mb-24">
              ...
              <h2 className="text-5xl font-extrabold text-white">Our Core Pillars</h2>
           </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
              {[
                ...
                <div key={i} className="group p-10 bg-white/5 border border-white/10 hover-lift backdrop-blur-sm rounded-sm">
                   <div className="w-12 h-1 bg-accent mb-8 group-hover:w-full transition-smooth" />
                   <h3 className="text-2xl font-bold text-white mb-6 leading-tight">{val.title}</h3>
