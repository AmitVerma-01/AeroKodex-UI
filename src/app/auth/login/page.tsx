...
const LoginPage = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 py-12 px-6">
      <div className="max-w-md w-full bg-white border border-border p-10 shadow-sm animate-fade-in">
        ...
        <form className="space-y-6">
          <div className="space-y-2">
            ...
            <input 
              type="email" 
              className="w-full p-4 text-sm border border-border focus:outline-none focus:border-primary transition-colors bg-white" 
          ...
          <div className="flex items-center">
            <input type="checkbox" id="remember" className="w-4 h-4 border-border rounded text-primary focus:ring-primary" />
