        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-4">
             <div className="aspect-square bg-muted border border-border overflow-hidden rounded-sm">
                <img src="https://images.unsplash.com/photo-1590674033140-107297920ab4?q=80&w=2070&auto=format&fit=crop" className="w-full h-full object-cover" alt="High-Modulus Carbon Fiber Sheet" />
             </div>
             ...
             <div className="space-y-4">
                ...
                <div className="border border-border rounded-sm overflow-hidden">
                   {[
                     ...
                     <div key={i} className={`flex justify-between p-4 text-sm ${i % 2 === 0 ? 'bg-card' : 'bg-muted'}`}>
      ...
      <section className="bg-muted py-24 border-t border-border mt-12">
        <div className="max-w-7xl mx-auto px-6">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[1,2,3].map(i => (
                <div key={i} className="bg-card p-6 border border-border rounded-sm hover-lift shadow-sm">
                   <div className="aspect-video bg-muted mb-6 rounded-sm" />
                   <h4 className="font-bold mb-2 text-foreground">High-Temp Epoxy Resin</h4>
